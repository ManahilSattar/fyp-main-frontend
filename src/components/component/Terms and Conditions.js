...
export const TermsCondition = () => {
  return (
    <div>
        <h1 align = 'center'>Terms and Conditions</h1><br></br>
        <p align = "justify" margin-top = '10px'>The following booking conditions form the basis of your contract with Adventure Alternative Ltd ("we", "us" and "our"). Please read them carefully as they set out our respective rights and obligations. By asking us to confirm your booking, we are entitled to assume that you have had the opportunity to read and have read these booking conditions and agree to them.
These booking conditions only apply to the trip arrangements which you book with us in the UK and which we agree to make, provide or perform (as applicable) as part of our contract with you. All references in these booking conditions to "trip", "booking", "contract" or "arrangements" mean such trip arrangements unless otherwise stated. References to "departure" mean the start date of these arrangements.</p>
        <br></br>
        <h3>Booking your trip and payment details</h3><br></br>
          <p><b>1. To make a booking </b>please follow the procedure shown on our website or ask for an offline application form. The relevant application form needs to be completed by each person travelling. Where you are under 18 at the time of booking, the application form also needs to be signed by your parent or guardian or initialled online during the booking process. The completed booking form must then be sent to us together with the payments referred to in paragraph 2 below.
...
If any information given in the application form or medical questionnaire is shown to be materially incorrect or incomplete, we reserve the right to cancel your booking or terminate your participation in the trip, depending on when we become aware of the true position. In this situation, cancellation charges as set out in paragraph 7 will apply and we will not be responsible for any costs or expenses incurred as a result.
    ...
    <h3>Cancellations and changes </h3><br></br>
 <p>
   <b>
   8. Cancellation of bookings: </b>
must be notified to us by letter or email by the party leader as soon as possible. Your notice of cancellation will only be effective when it is received in writing by us. Except as set out in paragraph 8 below, the following cancellation charges will be payable.
Period before departure within which written notification of cancellation is received by us Cancellation charge per person cancelling (% of total cost) 12 weeks or more 12 - 6 weeks	£100.00 25% 6 to 2 weeks 50% 2 weeks to date of departure or later 100%
   </p><br></br>
   <p>
     <b>9.</b>
     Depending on the <b>reason for cancellation</b>, you may be able to reclaim these cancellation charges (less any applicable excess) under the terms of your insurance policy. Claims must be made directly to the insurance company concerned. Where a part cancellation of a booking affects the basis on which the price was calculated, we will recalculate and re-invoice you accordingly.</p>   
    <p>
      <b>10. </b>
 ...
 Most changes are minor. Occasionally, we have to make a "significant change". A significant change is a change made before departure which we can reasonably be expected to have a major effect on your trip. If we have to make a significant change or cancel, we will tell you as soon as possible. 
    </p><br></br>
